package org.firedetection.biz.web.common;
...
public class AuthenticInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (requestUrl.equals("http://54.200.40.252:8080/") || requestUrl.equals("https://inturn.cf/")
				...
				|| requestUrl.contains("/sendNewPW.do") || requestUrl.contains("/naverLogin.do")
				|| requestUrl.contains("/main.do") || requestUrl.contains("/successSignup.do")
				|| requestUrl.contains("/profileForm.do") || requestUrl.contains("/chkId.do")
