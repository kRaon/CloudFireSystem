...
<head>
	...
	<script type="text/javascript" src="js/board/modifyQnaBoard.js"></script>
	...
	<jsp:include page="../navibar.jsp" />
 	<div class="container-wrap">
 		<div class="row">
 			...
 			<div class="col-sm-10">
			    <form action="/modifyQnaBoard.do" method="post" id="modifyBoardFrm" enctype="multipart/form-data">
			    	<div class="row">&nbsp;</div>
			    	<div class="row">
