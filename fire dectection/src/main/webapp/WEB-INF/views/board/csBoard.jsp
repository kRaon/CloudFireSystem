...
<link rel="stylesheet" href="css/board/csBoard.css">
<script type="text/javascript" src="js/board/csBoard.js"></script>
<title>cs Board</title>
</head>
<body>
	...
	<div class="container-wrap">
				...
				<c:forEach var="i" begin="1" end="${page}" step="1">
					<c:if test="${thisPage eq i}">
						<li class="page-item active"><a class="page-link"
							href="csBoard.do?page_num=${i}">${i}</a></li>
					</c:if>
		...
		<div class="row">
			<form action="searchcsBoard.do" method="post">
